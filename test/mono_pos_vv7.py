...
def main():
    ...
    # Pose 및 Beverage Detection 스레드 실행
    pose_beverage_thread = threading.Thread(target=run_pose_and_beverage_estimation, args=(webcam_processor, result_queue))
    pose_beverage_thread.start()
    ...
    try:
        while True:
            if not result_queue.empty():
                ...
                elif task == 'pose_and_beverage':
                    cv2.imshow("Pose and Beverage Detection", frame)
